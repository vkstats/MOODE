...
objfun<-function(X1, X2, P, Q, 
  ...
  if(criterion.choice=="GDP") {Xcrit<-criteria.GDP(X1, X2, P, Q, kappa.DP, kappa.Ds, kappa.LoF, kappa.bias, Nruns)}
  ...
  if(criterion.choice=="MSE.P") {Xcrit<-criteria.mseP(X1, X2, P, Q, kappa.DP, kappa.Ds, kappa.LoF, kappa.mse, Nruns)}
  return(Xcrit)
}
